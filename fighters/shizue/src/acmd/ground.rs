...
unsafe extern "C" fn game_attack11(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ...
        AttackModule::set_add_reaction_frame(boma, 0, 22.0, false);
        AttackModule::set_add_reaction_frame(boma, 1, 22.0, false);
        AttackModule::set_add_reaction_frame(boma, 2, 22.0, false);
    }
    wait(lua_state, 2.0);
    if is_excute(agent) {
