...
unsafe extern "C" fn game_attackairf(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        let addSpeed1 = Vector3f{ x: 0.0, y: 0.5, z: 0.0 };
    ...
    if is_excute(agent) {
        let addSpeed2 = Vector3f{ x: 0.0, y: 2.0, z: 0.0 };
    ...
    if is_excute(agent) {
        let addSpeed3 = Vector3f{ x: 0.0, y: 1.45, z: 0.0 };
    ...
    if is_excute(agent) {
        let addSpeed4 = Vector3f{ x: 0.0, y: 0.6, z: 0.0 };
