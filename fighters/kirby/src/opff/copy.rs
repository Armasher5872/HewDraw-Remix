...
// Terry
unsafe fn magic_series_terry(fighter: &mut L2CFighterCommon) {
    ...
    if fighter.is_status_one_of(&[
        ...
        *FIGHTER_STATUS_KIND_ATTACK_LW3
        ...
        || (
            ...
            if fighter.is_status(*FIGHTER_STATUS_KIND_ATTACK_HI3)
            && (AttackModule::is_infliction_status(fighter.module_accessor, *COLLISION_KIND_MASK_HIT)
            && !fighter.is_in_hitlag()) {
                fighter.check_jump_cancel(false, false);
            }
    ...
    if fighter.is_status_one_of(&[
        ...
        *FIGHTER_STATUS_KIND_ATTACK_LW4
        ...
        || (
            ...
            if fighter.is_status(*FIGHTER_STATUS_KIND_ATTACK_HI4)
            && (AttackModule::is_infliction_status(fighter.module_accessor, *COLLISION_KIND_MASK_HIT)
            && !fighter.is_in_hitlag()) {
                fighter.check_jump_cancel(false, false);
            }
...
pub unsafe fn kirby_copy_handler(fighter: &mut L2CFighterCommon) {
    ...
    match copy {
        ...
        // Terry
        0x55 => magic_series_terry(fighter),
        // Byleth
