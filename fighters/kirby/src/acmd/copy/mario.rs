...
unsafe extern "C" fn effect_mariospecialnfire(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ...
        EFFECT_FOLLOW(agent, Hash40::new("sys_bomb_a"), Hash40::new("top"), 1, 7.0, 10.5, 0, 0, 0, 0.26, true);
        LAST_EFFECT_SET_COLOR(agent, 0.65, 0.2, 0.08);
        LAST_EFFECT_SET_RATE(agent, 0.75);
        EFFECT_FOLLOW(agent, Hash40::new("sys_damage_fire"), Hash40::new("top"), 1, 6.0, 10.5, 0, 0, 0, 0.9, true);
        LAST_EFFECT_SET_RATE(agent, 0.55);
        EFFECT_FOLLOW(agent, Hash40::new("sys_damage_fire"), Hash40::new("top"), 1, 5.0, 10.5, 0, 0, 0, 0.9, true);
        LAST_EFFECT_SET_RATE(agent, 0.55);
