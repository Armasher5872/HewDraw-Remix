...
unsafe extern "C" fn effect_attackdash(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ...
        EFFECT_FOLLOW(agent, Hash40::new("peach_attack_impact"), Hash40::new("trans"), 0, 7.5, 8.0, 0, 90, 0, 1.0, true);
    ...
    if is_excute(agent) {
        ...
        EffectModule::set_scale(boma, effect as u32, &Vector3f::new(0.64, 0.64, 0.64));
    }
