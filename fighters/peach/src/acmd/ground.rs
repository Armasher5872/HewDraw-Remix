...
unsafe extern "C" fn effect_attackdash(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ...
        EFFECT_FOLLOW(agent, Hash40::new("peach_attack_impact"), Hash40::new("trans"), 0, 7.5, 9.3, 0, 90, 0, 1, true);
    }
