...
pub unsafe fn damage_fly_common_init(fighter: &mut L2CFighterCommon) {
    ...
    if VarModule::is_flag(fighter.battle_object, vars::common::instance::FORCE_TECHABLE_KNOCKDOWN) {
        WorkModule::unable_transition_term(fighter.module_accessor, *FIGHTER_STATUS_TRANSITION_TERM_ID_DAMAGE_FLY_REFLECT_D);
    }
    VarModule::off_flag(fighter.battle_object, vars::common::instance::FORCE_TECHABLE_KNOCKDOWN);
    original!()(fighter)
}
