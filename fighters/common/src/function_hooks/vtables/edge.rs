...
pub fn install() {
    unsafe {
        ...
        let _ = skyline::patching::Patch::in_text(0x518a860 + (*WEAPON_KIND_EDGE_FLASH as usize * 0x1d * 0x8)).data(text.add(0x33b8cf0 / 0x8));
    }

    let _ = skyline::patching::Patch::in_text(0x51c1ff0).data(edge_flash_on_search as u64);
}