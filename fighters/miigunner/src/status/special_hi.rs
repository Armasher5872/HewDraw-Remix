...
unsafe extern "C" fn special_hi1_pre(fighter: &mut L2CFighterCommon) -> L2CValue {
...
// unsafe extern "C" fn special_hi1_main(fighter: &mut L2CFighterCommon) -> L2CValue {
...
unsafe extern "C" fn special_hi1_end(fighter: &mut L2CFighterCommon) -> L2CValue {
...
pub fn install(agent: &mut Agent) {
    agent.status(Pre, *FIGHTER_STATUS_KIND_SPECIAL_HI, special_hi1_pre);
    // agent.status(Main, *FIGHTER_STATUS_KIND_SPECIAL_HI, special_hi1_main);
    agent.status(End, *FIGHTER_STATUS_KIND_SPECIAL_HI, special_hi1_end);
