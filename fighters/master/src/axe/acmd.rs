...
unsafe extern "C" fn game_speciallw(agent: &mut L2CAgentBase) {
    ...
    if is_excute(agent) {
        ...
        if VarModule::get_int(owner_module_accessor.object(), vars::master::status::SPECIAL_LW_HOLD) == 0 {
            ATTACK(agent, 0, 0, Hash40::new("haver"), 18.0, 51, 93, 0, 60, 5.7, 0.0, 14.0, 1.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_THRU, *ATTACK_LR_CHECK_F, false, 32, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_MASTER_AXE, *ATTACK_REGION_OBJECT);
    ...
    if is_excute(agent) {
        ...
        && VarModule::get_int(owner_module_accessor.object(), vars::master::status::SPECIAL_LW_HOLD) == 0 {
            ATTACK(agent, 0, 0, Hash40::new("haver"), 24.0, 275, 50, 0, 20, 5.7, 0.0, 14.0, 1.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_THRU, *ATTACK_LR_CHECK_F, false, 32, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_L, *COLLISION_SOUND_ATTR_MASTER_AXE, *ATTACK_REGION_OBJECT);
            ATK_SET_SHIELD_SETOFF_MUL(agent, 0, 3.0);
        }
    }
